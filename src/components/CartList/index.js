...
const CartList = ({ harga, satuan, listTotal, setListTotal, setEndTotal }) => {
    ...
    return (
        <View style={{
            ...
            <View style={{ flexDirection: 'column', justifyContent: 'space-evenly', height: 70 }}>
                <Text style={{ height: 35, width: wp('37.5%'), fontSize: 25, fontWeight: 'bold', color: 'black' }}>Nama Product</Text>
                <Text style={{ height: 20, width: wp('37.5%'), fontSize: 15, color: 'black' }}>Ini adalah keterangan product</Text>
            </View>
            <View style={{ flexDirection: 'column', alignItems: 'flex-end', justifyContent: 'space-evenly', height: 70, marginTop: 5 }}>
                <Text style={{ height: 20, fontSize: 15, color: 'black' }}>Rp. {total}</Text>
                <RNPickerSelect
                    style={{
                        ...pickerSelectStyles,
                        placeholder: {
...
const TotalView = ({JumlahTotal}) => {
    return (
        <View style={{ flexDirection: 'row', alignItems: 'center', width: wp('75%'), justifyContent: 'space-around' }}>
            <Text style={{ color: 'black', fontWeight: 'bold', fontSize: 40 }}>Total</Text>
