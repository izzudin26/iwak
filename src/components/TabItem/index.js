...
const TabItem = ({ isFocused, onLongPress, onPress, label, navigation }) => {
    ...
    const Icons = () => {
        ...
        if (label === "Chat") return isFocused ? <Icon
            name='comments'
            type='font-awesome'
            color='#F0C341'
            size={30}
        ...
        if (label === "Wishlist") return isFocused ? <Icon
            name='heart'
            type='font-awesome'
            color='#F0C341'
            size={30}
        ...
        if (label === "Product") return isFocused ? <Icon
            name='shopping-bag'
            type='font-awesome'
            color='#F0C341'
            size={30}
        ...
        if (label === "Account") return isFocused ? <Icon
            name='user'
            type='font-awesome'
            color='#F0C341'
            size={30}
