            ...
            <View style={{ alignSelf: 'center', marginBottom: 20 }}>
                <View style={styles.bigSale}>
                    <Image
                        ...
                        style={{ position: 'absolute', zIndex: -2, alignSelf: 'flex-end', marginVertical: 20, opacity: 0.8 }}
                    />
                ...
                <View style={styles.promo}>
                    <Image
                        ...
                        style={{ position: 'absolute', zIndex: -2, alignSelf: 'flex-start', opacity: 0.8 }}
                    />
                ...
                <View style={styles.shopNow}>
                    <View style={{ flexDirection: 'row', minWidth: wp('68.75%') }}>
                        <Image
                            ...
                            style={styles.image}
                        />
                        <View style={{ flexDirection: 'column', marginTop: 10, maxWidth: wp('37.5%') }}>
